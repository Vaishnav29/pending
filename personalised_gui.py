...
Label(root,  text='|'*50, wraplength=1 , background='#7E85AB').place(relx = 0.34, rely = 0)
      
Label(root,  text='|'*50, wraplength=1 , background='#7E85AB').place(relx = 0.665, rely = 0)

toprec = Label(root, text = 'Top 5 recommendations for the selected \n furniture product : ', background='#7E85AB', fg = 'white')
toprec.place(relx = 0.05, rely = 0.33)

Label(root, text = 'Top 5 recommendations for the selected \n office product : ', background='#7E85AB', fg = 'white').place(relx = 0.365, rely = 0.33)

Label(root, text = 'Top 5 recommendations for the selected \n technology product : ', background='#7E85AB', fg = 'white').place(relx = 0.695, rely = 0.33)
