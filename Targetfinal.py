...
# cluster
Label(root,  text='Marketing on Customers of different groups', background='#7E85AB', fg = 'white', font=("Helvetica", 13,'bold', 'underline')).place(relx = 0.04, rely = 0.01)   
Label(root,  text='Marketing on product categories', background='#7E85AB', fg = 'white', font=("Helvetica", 13,'bold', 'underline')).place(relx = 0.6, rely = 0.01)   
...
Label(root,  text='|'*50, wraplength=1 , background='#7E85AB').place(relx = 0.5, rely = 0)

bp = Label(root,text='Customer Name - Best Categories',width=25, background='#7E85AB', fg = 'white')
bp.place(relx = 0.1, rely = 0.21)

offerLabel = Label(root,text='Products frequentyly bought by these customers: ', background='#7E85AB', fg = 'white')
...
cc = Label(root,text='Customer Name',width=20, background='#7E85AB', fg = 'white')
